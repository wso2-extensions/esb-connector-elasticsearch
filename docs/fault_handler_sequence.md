# Configuring the Elasticsearch Fault Handler Sequence

Following is a sample proxy service and fault handler sequence you can use as a starting point for handling faults when integrating with Elasticsearch. Customize this sample to match your requirements.

**Sample Proxy**
```xml
<?xml version="1.0" encoding="UTF-8"?>
<proxy xmlns="http://ws.apache.org/ns/synapse" name="elasticSearch_sampleProxy" transports="https,http" statistics="disable" trace="disable" startOnLoad="true">
  <target>
